...
def generate_answer(
    ...
    *,
    ...
    # Align positions to follow the prefed context already stored in the cache.
    # The question tokens come after the prefed context, so their positions
    # start at `position_base` rather than zero.
