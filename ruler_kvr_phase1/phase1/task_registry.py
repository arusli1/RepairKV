...
def build_task_example(task_name: str, index: int, target_context_length: int, tokenizer) -> TaskExample:
    ...
    if spec.family == "vt":
        ...
        return build_vt_example(task_name, index, target_context_length, tokenizer, **spec.params)
    if spec.family == "niah":
        # "niah" tasks have their own builder with similar call signature.
        return build_niah_example(task_name, index, target_context_length, tokenizer, **spec.params)
