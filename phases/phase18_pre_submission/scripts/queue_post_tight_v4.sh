...
until grep -qE "all multipliers done" phases/phase18_pre_submission/results/w1_tight/logs/tight_mult1.05_20260506T*.log 2>/dev/null; do
    sleep 60
done
